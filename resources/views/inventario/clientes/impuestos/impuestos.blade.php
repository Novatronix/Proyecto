...
@section('htmlheader_title') Impuestos @endsection
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <h3 class="page-header">
              ...
              <a class="btn btn-primary" href="{{ url('/inventario/impuestos.nuevo/') }}">
                <i class="fa fa-plus"></i> Nuevo Impuesto
              </a>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                              ...
                              <a class="btn btn-primary" href="{{ url('inventario/impuestos.editar/'.Crypt::encrypt($doc->id))}}">
